...
const About = ({ currentLang }: AboutProps) => {
  const content = {
    en: {
      ...
      bio3: "Beyond software development, I'm also a speaker and teacher who actively participates in tech events and educational programs. I have a strong interest in collaborative environments and developer communities, where I can share knowledge and learn from other professionals. I regularly conduct workshops, training sessions, and speak at conferences to help other developers grow in their careers.",

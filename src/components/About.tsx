...
const About = ({ currentLang }: AboutProps) => {
  const content = {
    en: {
      ...
      bio: "I'm William Correa, a software developer with extensive experience in various areas of development, from planning and execution to infrastructure. I hold a degree in Computer Science and have been active in the industry since 2007.",
      ...
      bio3: "Beyond software development, I'm also a speaker, teacher, and instructor who actively participates in tech events and educational programs. I have a strong interest in collaborative environments and developer communities, where I can share knowledge and learn from other professionals. I regularly conduct workshops, training sessions, and speak at conferences to help other developers grow in their careers.",
      highlights: "Key Highlights",
      highlight1: "17+ Years Experience",
      highlight1Desc: "Professional software development since 2007",
    ...
    pt: {
      ...
      bio: "Sou William Correa, desenvolvedor de software com vasta experiência em diversas áreas do desenvolvimento, desde planejamento e execução até infraestrutura. Tenho formação em Ciência da Computação e atuo na área desde 2007.",
      ...
      bio3: "Além do desenvolvimento de software, sou também palestrante, professor e instrutor que participa ativamente de eventos tech e programas educacionais. Tenho forte interesse em ambientes colaborativos e comunidades de desenvolvedores, onde posso compartilhar conhecimento e aprender com outros profissionais. Conduzo regularmente workshops, treinamentos e palestro em conferências para ajudar outros desenvolvedores a crescerem em suas carreiras.",
      highlights: "Principais Destaques",
      highlight1: "17+ Anos de Experiência",
      highlight1Desc: "Desenvolvimento profissional de software desde 2007",

...
const About = ({ currentLang }: AboutProps) => {
  const content = {
    en: {
      ...
      bio3: "In addition to software development, I have a strong interest in collaborative environments and developer communities, where I can share knowledge and learn from other professionals. When I'm not working, I enjoy getting involved in activities that promote the growth of tech communities.",
    ...
    pt: {
      ...
      bio3: "Além do desenvolvimento de software, tenho forte interesse em ambientes colaborativos e comunidades de desenvolvedores, onde posso compartilhar conhecimento e aprender com outros profissionais. Quando não estou trabalhando, gosto de me envolver em atividades que promovem o crescimento de comunidades tech.",
